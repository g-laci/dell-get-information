...
const CLIENT_ID = process.env.DELL_CLIENT_ID;
const CLIENT_SECRET = process.env.DELL_CLIENT_SECRET;
const TOKEN_URL = process.env.DELL_TOKEN_URL;
                ...
                for (const tag of serviceTags) {
                    try {
                        ...
                        if (asset?.invalid) {
                            ...
                            // Still emit a result so the UI can render "not found"
